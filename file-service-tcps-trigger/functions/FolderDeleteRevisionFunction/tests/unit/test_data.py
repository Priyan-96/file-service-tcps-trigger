...
def get_folder_delete_event_json(modified: datetime = datetime.now()):
    ...
    """
    folder_delete_event = {
        "jobId": "73ad4588-9d26-44d3-bad0-ce285e23f44a",
        "jobType": "FOLDER_DELETE",
        "status": "COMPLETED",
...
def get_empty_folder_delete_event_json(modified: datetime = datetime.now()):
    ...
    empty_folder_event = {
        ...
        "result": {
            "objectToDelete": {
                "storageObjectId": 281474977720987,
                "type": "FOLDER",
                "name": "12",
                "projectId": 281474976771064,
                "origStorageObjectId": 281474977720987,
                "createdBy": 2970369,
                "modifiedBy": 2970369,
                "sizeInBytes": 0,
                "flag": None,
                "contentChangeStorageObjectId": 281474977720987,
                "storageObjectPathId": 281474977035209,
            ...
            "objectDeleted": {
                "storageObjectId": 281474977720988,
                "type": "FOLDER",
                "name": "12",
                "projectId": 281474976771064,
                "origStorageObjectId": 281474977720987,
...
def get_expected_empty_folder_delete_request_body(folder_event: FolderDeleteQueueMessage) -> Dict:
    ...
    request_body = {
        ...
        "activityId": folder_event.input.activity_id,
        "downloadUrl": None,
        "objectToDelete": asdict(folder_event.result.object_to_delete) if folder_event.result.object_to_delete else None,
