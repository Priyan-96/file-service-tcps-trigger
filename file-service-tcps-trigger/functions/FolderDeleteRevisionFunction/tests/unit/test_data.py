...
from model.folder_event import FolderDeleteQueueMessage, FolderDeleteInput, FolderDeleteResult, UserInput
...
def get_folder_delete_event_json(modified: datetime = datetime.now()):
    ...
    """
    folder_delete_event = {
        "job_id": "73ad4588-9d26-44d3-bad0-ce285e23f44a",
        "job_type": "FOLDER_DELETE",
        "status": "COMPLETED",
        "project_id": "Rm6SfQd9h6Y",
        "created_by": {
            "id": "drcigGWu0pM",
        ...
        "input": {
            "folder_id": "ljtORDtSe-U",
            "activity_id": "Dyfw481fE9U"
        },
        "result": {
            "download_url": "https://example.com/folder/download/ljtORDtSe-U"
        }
    }
